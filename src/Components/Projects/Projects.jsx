    ...
    return (
        <div>
            <div className="section">
					<h3 className="sectionTitle" id="projects">My Projects</h3>
					<p className="sectionSubTitle">1.Find Your Hat</p><p
						className="des"
					>
...
index.js"
					...
					<p className="sectionSubTitle">2.Jammming</p><p className="des">
					</p><p className="des">
                    ...
                    <p className="sectionSubTitle">4.Forecasting Electricity Power Demand in Metropolitan
and Provincial Areas Using Decomposition Method with
Seasonal ARIMA and Modified SARIMA Model</p>
					<p className="des">
						&nbsp;&nbsp;&nbsp;&nbsp;Final year project: Studied and compared time-series forecasting method
4 method with 3 data set of electricity power demand in
Thailand.
